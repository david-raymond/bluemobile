...
Designed for 2 persons {#designed-for-two-persons}
----------------------
...
In particular, we plan to **not** have:

- [AC unit](#no-ac)
- Fixed ladder
- Decorative skirts and outside storage compartments and doors (in particular, no outside propane compartment and no propane heater or water heater vent)
- Grey and black water flush system ([no fixed shower or toilet](#no-fixed-shower-toilet) and no water tanks)
- Grid power connector and city water inlet on van wall (they will be concealed under the rear bumper)
- Decorative stripes on vehicle

Perhaps from the outside the only things which will somewhat spoil the stealthiness are:

- Roof vent (not very visible though)
- Rigid solar panels (visible on the edges of the roof)
- Windows (round corner aftermarket windows kind of suggest a camping vehicle)

But given we still want to have well equipped and convenient camper van, we believe these are acceptable compromises.

Emphasis on electricity {#emphasis-on-electricity}
-----------------------
...
We do not intend to use our camper van in cold weather. But we do intend to travel in North America where even when not in the cold season, nights can be quite chilly. For example during our fall [roadtrip in the American West](intro-inception.html#road-trip-american-west), the temperature went down to around 5 &deg;C/41 &deg;F. We need our van to be equipped for such weather.

We do not want a fixed propane installation so heat needs to be generated with an electric heater (connected to grid power).

Fixed electric heaters made for the RV market do not seem very common. We did not specifically search for such a product, but we are pretty sure if some exist, they will be quite expensive compared to small basic portable electric heaters which would be as efficient (see <a href="http://www.damouth.org/RVStuff/PortHeat.shtml" target="_blank">http://www.damouth.org/RVStuff/PortHeat.shtml</a>) and would not occupy a fixed space inside a cabinet.

And we happen to already own such a small electric heater.

{% include image.html file="SmallPortableHeater.jpg" caption="Small portable heater" %}

It is on the noisy side (it vibrates and rattles during operation from the vibration induced by the fan). At worst, if we cannot fix it or tolerate the noise, we will purchase another quieter one. Not a big deal for around 50 $ CAD, maybe less. 

So heating the inside of the camper van will be done with a small portable electric heater.

Such heaters have a maximum power of around 1500 W which is not much (compared to propane heaters). See [insulation boards](build-inner-wrapping.html#insulation-boards) and the other sections on that page related to insulation for more on this.

No fixed shower and toilet {#no-fixed-shower-toilet}
--------------------------
...
No traditional dinette area {#no-traditional-dinette-area}
---------------------------
...
Large refrigerator-freezer {#large-refrigerator-freezer}
--------------------------
...
At first, it was clear we wanted to have an AC (air conditioning) unit on the roof of our van so that we sleep comfortably during those hot summer nights. Camping in the lower US states right in the middle of summer requires some AC.

We camped years ago in Myrtle Beach during summer, and we would not even have breakfast in the morning outside because it was uncomfortably hot compared to the inside of our AC-equipped travel trailer.

But then, we gave this a lot of thoughts and came up with quite a few arguments:

- A roof-mounted AC unit is not [stealthy](#stealthiness)
- A roof-mounted AC unit is uncomfortably noisy, especially when sleeping (the one in our travel trailer certainly was, and from the browsing we did on the Internet, none of them are worhy of being called quiet)
- A roof-mounted AC unit permanently causes aerodynamic drag
- A roof-mounted AC unit steals space that could be used for an additional solar panel
- A roof-mounted AC unit can cause shade on solar panels (see <a href="https://roadslesstraveled.us/solar-panels-rv-off-grid-flexible-rigid-12-24-volt-monocrystalline-polycrystalline/" target="_blank">https://roadslesstraveled.us/solar-panels-rv-off-grid-flexible-rigid-12-24-volt-monocrystalline-polycrystalline/</a>)
- A portable AC unit takes significant space inside the camper van
- An (efficient) portable AC unit needs 2 cumbersome vents to the outside
- Some camper van conversion install a fixed interior AC unit with a dedicated square vent outside, but this still takes space, reduced stealthiness and requires cutting a hole in the van wall
- An AC unit requires grid power (cannot be operated from the batteries)

Wow, that's a fair number of cons!

We were also told that a simple efficient roof fan (which we want anyways) can be very effective in keeping the inside of a camper van comfortable to the point of not requiring an AC unit for sleeping. To be honest, we do not believe a roof fan can replace an AC unit in very hot weather. But we nevertheless decided to go without an AC unit altogether and plan our road trips in such a way as to avoid high heat areas and periods, especially during the night.
...
Minimize new holes {#minimize-new-holes}
------------------

Drilling or cutting holes in the metal parts of our new vehicle makes us uncomfortable. We wanted to avoid it as much as possible.

Of course, some new holes are unavoidable:

- Windows
- Roof vent
- Strong brackets for 2<sup>nd</sup> row [bench seat](build-bench-seat.html)

But as much as possible, we avoided it. In particular, we did not want to drill new holes for:
